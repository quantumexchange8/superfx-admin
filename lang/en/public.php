...
return [
    ...
    "greater_than_30_days" => "Greater than 30 days",
    ...
    "select_payment_platform" => "Select Payment Platform",
    ...
    "settings" => "Settings",
    "no_settings_header" => "No Setting Yet",
    "no_settings_caption" => "It seems there are no setting records at the moment. Once setting are created, you'll see them here!",
    "loading_settings" => "Loading settings data. Please wait.",
    "deactivate_setting_header" => "Deactivate Settings",
    "deactivate_setting_message" => "Are you sure you want to deactivate this setting? This will hide the setting.",
    "activate_setting_header" => "Activate Settings",
