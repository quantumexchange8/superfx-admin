...
return [
    ...
    "deactivate_account_type_content" => "Are you sure you want to deactivate this account type? This will hide the account type.",
    "deactivate" => "Deactivate",
    "activate_account_type_header" => "Activate Account Type",
    "activate_account_type_content" => "Are you sure you want to activate this account type? This will display the account type to user.",
    "confirm" => "Confirm",
    ...
    "deactivate_profile_content" => "Are you sure you want to deactivate this profile? This will hide the profile.",
    "activate_profile_header" => "Activate Profile",
    "activate_profile_content" => "Are you sure you want to activate this profile? This will display the profile to user.",
